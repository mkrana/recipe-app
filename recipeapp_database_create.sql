...
create table recipe_category_mapping (recipe_id bigint not null, category_id bigint not null, primary key (recipe_id, category_id)) engine=InnoDB;
...
alter table recipe_category_mapping add constraint FKo6ic4v041qy0d09yo4lne766d foreign key (category_id) references category (id);
alter table recipe_category_mapping add constraint FK2tmndl8xj0qx6r80tg9rx1hr3 foreign key (recipe_id) references recipe (id);